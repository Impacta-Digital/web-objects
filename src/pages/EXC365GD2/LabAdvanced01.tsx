...
function LabAdvanced01() {
  ...
  return (
    <>
      ...
      <p className='--paddingLeft'>9. Desative as linhas de grade;</p>
      <p className='--paddingLeft'>
      ...
      <p className='--paddingLeft'>4. Copie a fórmula para baixo, até o mês de dezembro;</p>
      <p className='--paddingLeft'>
      ...
      <p className='--paddingLeft'>7. Se desejar, mude cor, espessura e estilo da linha da média;</p>
      <p className='--paddingLeft'>
      ...
      <p className='--paddingLeft'>10. Salve o arquivo.</p>
      ...
      <p className='--paddingLeft'>13. Teste o controle para verificar se ele liga ou desliga a linha de média;</p>
      <p className='--paddingLeft'>
        14. Ative o título do gráfico e vincule-o à célula <strong>B1</strong>;
      </p>
      <p className='--paddingLeft'>15. Ative a legenda do gráfico e posicione-a na parte superior;</p>
      <p className='--paddingLeft'>
      ...
      <p className='--paddingLeft'>17. Teste a caixa de seleção para ligar ou desligar os destaques da média;</p>
      <p className='--paddingLeft'>18. Desative as linhas de grade da planilha;</p>
      <p className='--paddingLeft'>
        19. Oculte as colunas <strong>D</strong>, <strong>E</strong> e <strong>R</strong>;
      </p>
      <p className='--paddingLeft'>20. Salve o arquivo.</p>
