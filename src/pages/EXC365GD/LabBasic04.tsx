...
function LabBasic04() {
  ...
  return (
    <>
      ...
      <p className='--bulleted --paddingLeft'>
      ...
      <p className='--paddingLeft'>3. Mova a legenda para a parte superior e exclua o título do gráfico;</p>
      <p className='--paddingLeft'>
      ...
      <p className='--paddingLeft'>11. Desative as linhas de grade;</p>
      ...
      <p className='--paddingLeft'>4. Mova a legenda do gráfico para a parte superior;</p>
      <p className='--paddingLeft'>
      ...
      <p className='--paddingLeft'>7. Exclua o título do gráfico;</p>
      <p className='--paddingLeft'>8. Ligue as linhas de grade horizontais secundárias;</p>
      <p className='--paddingLeft'>9. Ligue as linhas de grade verticais principais;</p>
      <p className='--paddingLeft'>
      ...
      <p className='--paddingLeft'>11. Desative as linhas de grade da planilha;</p>
      <p className='--paddingLeft'>12. Salve o arquivo.</p>
