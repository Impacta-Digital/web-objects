...
function LabBasic03() {
  ...
  return (
    <>
      ...
      <p className='--padding-left'>8. Teste todos os hiperlinks entre as planilhas;</p>
      <p className='--padding-left'>
        9. Na planilha <strong>Menu</strong>, oculte as colunas <strong>N</strong>, <strong>O</strong> e{' '}
        <strong>P</strong>;
      </p>
      <p className='--padding-left'>10. Desative os títulos de linha e coluna;</p>
      <p className='--padding-left'>11. Nas opções do Excel, desative as guias de planilha;</p>
      <p className='--padding-left'>12. Salve e feche o arquivo.</p>
